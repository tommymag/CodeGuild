...
dict_of_terms = {  # Will need to figure out case sensitve - levels of difficulty
...
while True:
    ...
    dict_of_terms[new_term] = definition
...
game_start = input("Doctor Godfrey: So... \"You think you can become master programmer?!\""):
if game_start == "y":
    begin
